...
#define NRF5340_COMPATIBLE // only using single spi on thingy53
#include <mcu.h>
...
uint32_t flash_impl_get_typical_sector_erase_duration_ms(void) { return 800; } // TODO: maybe see if the high performance mode can be enabled to get these numbers down?

uint32_t flash_impl_get_typical_subsector_erase_duration_ms(void) { return 60; } // TODO: maybe see if the high performance mode can be enabled to get these numbers down?
